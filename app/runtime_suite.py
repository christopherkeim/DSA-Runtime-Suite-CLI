...
from app.search import search_reverse_matches
...
results_file_handler: logging.FileHandler = logging.FileHandler("results.log", mode="a")
results_file_handler.setLevel(logging.INFO)
logger.addHandler(results_file_handler)

# Paths to datasets
BABY_PATH: str = "tests/fixtures/baby_names_2020_short.txt"
SCRABBLE_PATH: str = "tests/fixtures/sowpods.txt"
